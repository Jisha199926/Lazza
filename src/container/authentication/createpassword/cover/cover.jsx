...
const Createcover = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <body className="bg-white dark:!bg-bodybg text-defaulttextcolor dark:text-defaulttextcolor/70 text-defaultsize"></body>
      </Helmet>
            ...
            <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
              <div className="p-[3rem]">
                ...
                <div className="text-center">
                  <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Back to home ? <Link to={`${import.meta.env.BASE_URL}dashboards/crm/`}
