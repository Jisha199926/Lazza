              ...
              <div className="box">
                  <div className="box-body !p-[3rem]">
                      ...
                      <div className="text-center">
                          <p className="text-[.75rem] text-[#8c9097] dark:text-white/50 mt-4 mb-0">Try unlock with different methods <Link className="text-success" to="#!"><u>Finger print</u></Link> / <Link className="text-success" to="#!"><u>Face Id</u></Link></p>
                      </div>
                  </div>
              </div>
            </div>
