                            ...
                            <div className="p-[3rem]">
                                ...
                                <div className="grid grid-cols-12 gap-y-4">
                                    ...
                                    <div className="xl:col-span-12 col-span-12 mb-4">
                                        <label htmlFor="signin-password" className="form-label text-default block">Password<Link to={`${import.meta.env.BASE_URL}authentication/resetpassword/resetcover`} className="ltr:float-right rtl:float-left text-danger">Forget password ?</Link></label>
                                ...
                                <div className="text-center">
                                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Dont have an account? <Link to={`${import.meta.env.BASE_URL}authentication/signup/signupcover`} className="text-primary">Sign Up</Link></p>
                                </div>
                            </div>
                        </div>
                        <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
