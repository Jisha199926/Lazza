  ...
  <Fragment>
    ...
    <div className="flex justify-center authentication authentication-basic items-center h-full text-defaultsize text-defaulttextcolor">
      <div className="grid grid-cols-12">
        <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
        <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12 flex flex-col">
            ...
            <div className="box-body sm:!p-[3rem]">
              ...
              <div className="grid grid-cols-12 gap-y-4">
                <div className="xl:col-span-12 col-span-12 mb-2">
                  ...
                  <div className="form-check mt-2 mb-0 !ps-0 !flex items-center">
