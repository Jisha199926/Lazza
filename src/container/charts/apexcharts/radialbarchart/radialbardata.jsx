...
export class Basicradialbar extends Component {
    ...
    render() {
        return (
            <ReactApexChart options={this.state.options} series={this.state.series} type="radialBar" height={290} />
...
export class Circlewithimage extends Component {
    ...
    render() {
        return (
            <ReactApexChart options={this.state.options} series={this.state.series} type="radialBar" height={310} />
