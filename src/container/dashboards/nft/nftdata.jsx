...
export class NFTStatistics extends Component {
    ...
    render() {
        return (
            <div>
                <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={335} />
            </div>
...
export const TopCollectors = [
    ...
    { id: 7, src: face14, name: 'Agire Khan', progress: 80, text1: '$15,236.00', text2: '6.345ETH', value: '85%' }
];
