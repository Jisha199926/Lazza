        ...
        <div>
            ...
            <nav className="btn-group steps basicsteps">
                {steps.map((step, index) => (
                    <Button key={index} onClick={() => props.onChange(index)} className={getClsNavBtn(index === currentIndex)}>
                        {step.props.title}
                    </Button>
                ))}
            </nav>
...
function Button({ visible, ...props }) {
    return (
        ...
        <button
            className={visible ? "ti-btn bg-primary text-white " : "invisible"}
            {...props}
        />
        ...
        return (
            <Wizard step={this.state.step} onChange={this.handleStep}>
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-[0.9375rem] font-semibold sm:flex block items-center justify-between mb-4">
                            ...
                            <div className="sm:mt-0 mt-2">
                                <Link to="#" className="ti-btn bg-primary text-white !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#modal-new-address"><i className="ri-add-line  align-middle text-[0.875rem] font-semibold inline-block"></i>Add New Address
                                </Link>
                ...
                <div className="p-[3rem] checkout-payment-success my-3">
                                            ...
                                            <div className="mb-6">
                                                <p className="mb-1 text-[0.875rem]">You can track your order with Order Id <b>SPK#1FR</b> from <Link className="link-success" to="#"><u className="text-success">Track Order</u></Link></p>
                                                <p className="text-[#8c9097] dark:text-white/50">Thankyou for shopping with us.</p>
                                            </div>
                                            <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/products/`} className="ti-btn bg-success text-white !font-medium">Continue Shopping<i className="bi bi-cart ms-2"></i></Link>
                                        </div>
                </Step>
            </Wizard>
        );
