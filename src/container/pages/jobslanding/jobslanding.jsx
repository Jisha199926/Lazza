    ...
    <div className="header-content-right">
        <div className="header-element !items-center">
            <div className="lg:hidden block">
                <a href={`${import.meta.env.BASE_URL}authentication/signup/signupbasic`} className="ti-btn ti-btn-primary !m-1">
                    Sign Up
                </a>
                <a aria-label="anchor" href="#" className="ti-btn m-1 p-2 px-3 ti-btn-success"
                data-hs-overlay="#hs-overlay-switcher"><i className="ri-settings-3-line animate-spin-slow"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div className="container-xl xl:!p-0">
      <div className="main-sidebar mx-0">
        <nav className="main-menu-container nav nav-pills flex-column sub-open">
          ...
          <div className="slide-left hidden" id="slide-left"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" 
          height="24" viewBox="0 0 24 24"> <path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path> </svg></div>
          <Navbar2/>
          <div className="slide-right hidden" id="slide-right"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24"
           height="24" viewBox="0 0 24 24"> <path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"></path> </svg></div>
          <div className="lg:flex hidden space-x-2 rtl:space-x-reverse">
            <Link to={`${import.meta.env.BASE_URL}authentication/signup/signupbasic`} className="ti-btn w-[6.375rem] ti-btn-primary-full m-0 p-2">Sign
              Up</Link>
              <Link className="ti-btn  bg-secondary text-white !font-medium me-[0.365rem] whitespace-nowrap" to={`${import.meta.env.BASE_URL}apps/jobs/jobpost/`}>Job Post</Link>
        ...
        <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding1} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
            ...
            <div className="lg:col-span-4 md:col-span-6 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding2} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
                        <div className="md:col-span-9 col-span-8 my-auto">
                            <div className="box-body">
            ...
            <div className="lg:col-span-4 md:col-span-6 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding3} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
                        <div className="md:col-span-9 col-span-8 my-auto">
                            <div className="box-body">
            ...
            <div className="lg:col-span-4 md:col-span-6 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding4} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
                        <div className="md:col-span-9 col-span-8 my-auto">
                            <div className="box-body">
            ...
            <div className="lg:col-span-4 md:col-span-6 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding5} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
                        <div className="md:col-span-9 col-span-8 my-auto">
                            <div className="box-body">
            ...
            <div className="lg:col-span-4 md:col-span-6 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="grid grid-cols-12 g-0">
                        <div className="md:col-span-3 col-span-4">
                            <img src={jobslanding6} className="img-fluid rounded-start h-full browse-jobs-image !rounded-s-md" alt="..."/>
                        </div>
                        <div className="md:col-span-9 col-span-8 my-auto">
                            <div className="box-body">
            ...
            <div className="col-span-12 md:col-span-4">
                <div className="box border dark:border-defaultborder/10">
                    <div className="box-body rounded">
                        ...
                        <Link className="mx-1 text-primary font-semibold leading-[1]" to="#">Register Now<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                    </div>
                </div>
            </div>
            <div className="md:col-span-4 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="box-body rounded">
                        ...
                        <Link className="mx-1 text-primary font-semibold leading-[1]" to="#">Complete Profile<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                    </div>
                </div>
            </div>
            <div className="md:col-span-4 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <div className="box-body rounded">
                        ...
                        <Link className="mx-1 text-primary font-semibold leading-[1]" to="#">Apply Now<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="box featured-jobs">
                    <div className="box-body">
                        <div className="btn-list ltr:float-right rtl:float-left">
                            <Link aria-label="anchor" to="#" className="wishlist-icon me-[0.375rem] mb-[0.375rem]" 
                          ><span><i className="bi bi-heart"></i></span></Link>
                            <Link aria-label="anchor" to="#" className="wishlist-icon me-[0.375rem] mb-[0.375rem] !text-warning" ><span><i className="bi bi-star-fill"></i></span></Link>
                        </div>
                        <div className="flex mb-4">
                            ...
                            <div className="ms-2">
                                <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link to="#"> HTML Developer - Fresher</Link></h5>
                                <Link to="#">Spotech Technical Solutions</Link>
                            </div>
                        </div>
                        <div className="popular-tags mb-4 space-x-1 rtl:space-x-reverse">
                            <Link to="#" className="badge rounded-pill bg-light text-default"><i className="bi bi-geo-alt text-[#8c9097] dark:text-white/50 me-1"></i> Hyderabad</Link>
                            <Link to="#" className="badge rounded-pill bg-light text-default"><i className="bi bi-briefcase text-[#8c9097] dark:text-white/50 me-1"></i> 13 Openings</Link>
                            <Link to="#" className="badge rounded-pill bg-light text-default"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                            <Link to="#" className="badge rounded-pill bg-light text-default"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Min - 2Years</Link>
                            <Link to="#" className="badge rounded-pill bg-light text-default"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</Link>
                        </div>
                        <div className="flex justify-between">
                            <h6 className="font-semibold mb-0 text-default text-[1rem]">$25,000 - $35,000</h6>
                            <Link to="" className="text-primary font-semibold text-[0.875rem]">
                ...
                <div className="box featured-jobs">
                    <div className="box-body">
                        ...
                        <div className="flex mb-4">
                            ...
                            <div className="ms-2">
                                <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link to="#"> React Lead Developer</Link></h5>
                ...
                <div className="box featured-jobs">
                    <div className="box-body">
                        ...
                        <div className="flex mb-4">
                            ...
                            <div className="ms-2">
                                <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link to="#"> Vuejs Frontend Developer</Link></h5>
                ...
                <div className="box featured-jobs">
                    <div className="box-body">
                        ...
                        <div className="flex mb-4">
                            ...
                            <div className="ms-2">
                                <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link to="#"> Wordpress Developer - Remote</Link></h5>
    ...
    <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <Link to="#">
                        <img src={blog1} className="!rounded-t-md" alt="..."/>
                    </Link>
                    <div className="box-body">
            ...
            <div className="md:col-span-1 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <Link to="#">
                        <img src={blog2} className="!rounded-t-md" alt="..."/>
                    </Link>
                    <div className="box-body">
            ...
            <div className="md:col-span-1 col-span-12">
                <div className="box border dark:border-defaultborder/10">
                    <Link to="#">
                        <img src={blog3} className="!rounded-t-md" alt="..."/>
                    </Link>
                    <div className="box-body">
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Json Taylor</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Melissa Blue</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Kiara Advain</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Jhonson Smith</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Dwayne Stort</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Jasmine Kova</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Dolph MR</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Brenda Simpson</p>
                      ...
                      <div className="box testimonial-card">
                          <div className="box-body">
                              <div className="flex items-center mb-4">
                                  ...
                                  <div>
                                      <p className="mb-0 font-semibold text-[0.875rem] text-primary">Julia Sams</p>
...
<div className="landing-main-footer py-4 opacity-[0.87]">
    <div className="container">
        <div className="flex flex-wrap gap-2 items-center justify-between">
            <div>
                <span className="text-white opacity-[0.7] text-[0.875rem]"> © Copyright <span id="year">2024</span> <Link
                    to="#" className="text-primary text-[0.9375rem] font-semibold">Ynex</Link>.
                </span>
            </div>
            <div>
