                        ...
                        <div className="col-span-12 xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8">
                            ...
                            <div className="box !p-[3rem]">
                                <div className="box-body" role="tabpanel" id="pills-with-brand-color-01" aria-labelledby="pills-with-brand-color-item-1">
                                    <p className="mb-2 font-semibold text-center h5">Log In</p>
                                    <p className="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal text-center">Welcome back Jhon !</p>
                                    {err && <div className="px-4 py-3 mb-2 shadow-md alert-danger" role="alert">
                                        <div className="flex">
                                            <div className="py-1">
                                            </div>
                                            <div>{err}</div>
                                    ...
                                    <div className="grid grid-cols-12 gap-y-4">
                                        ...
                                        <div className="col-span-12 mb-2 xl:col-span-12">
                                            <label htmlFor="signin-password" className="block form-label text-default">Password
                                    ...
                                    <div className="text-center btn-list">
                                ...
                                <div className="hidden box-body" role="tabpanel" id="pills-with-brand-color-02" aria-labelledby="pills-with-brand-color-item-2">
                                    ...
                                    <div className="grid grid-cols-12 gap-y-4">
                                        ...
                                        <div className="col-span-12 mb-2 xl:col-span-12">
                                            <label htmlFor="signin-password" className="block form-label text-default">Password<Link to={`${import.meta.env.BASE_URL}authentication/resetpassword/resetbasic`} className="float-end text-danger">Forget password ?</Link></label>
                                            <div className="input-group">
